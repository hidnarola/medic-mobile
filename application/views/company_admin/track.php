...
if (isset($_GET['track_start_date'])) {
    $track_start_date = date('d F, Y', strtotime($_GET['track_start_date']));
}
if (isset($_GET['track_start_time'])) {
    $track_start_time = date('h:i A', strtotime($_GET['track_start_time']));
}
if (isset($_GET['track_end_date'])) {
    $track_end_date = date('d F, Y', strtotime($_GET['track_end_date']));
}
if (isset($_GET['track_end_time'])) {
    $track_end_time = date('h:i A', strtotime($_GET['track_end_time']));
}
?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control pickadate-accessibility" placeholder="Select a date&hellip;" id="txt_track_start_date" name="track_start_date" value="<?php
                                    if ($track_start_date != '') {
                                        echo $track_start_date;
                                    } else {
                                        echo date('d F, Y');
                                    }
                                    ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control pickatime-hidden" placeholder="Try me&hellip;" name="track_start_time" id="txt_track_start_time" value="<?php
                                    if ($track_start_time != '') {
                                        echo $track_start_time;
                                    } else {
                                        echo '12:00 AM';
                                    }
                                    ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="icon-calendar22"></i></span>
                                    <input type="text" class="form-control pickadate-accessibility" placeholder="Select a date&hellip;" id="txt_track_end_date" name="track_end_date" value="<?php
                                    if ($track_end_date != '') {
                                        echo $track_end_date;
                                    } else {
                                        echo date('d F, Y');
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="icon-alarm"></i></span>
                                    <input type="text" class="form-control pickatime-hidden" placeholder="Try me&hellip;" name="track_end_time" id="txt_track_end_time" value="<?php
                                    if ($track_end_time != '') {
                                        echo $track_end_time;
                                    } else {
                                        echo '11:30 PM';
