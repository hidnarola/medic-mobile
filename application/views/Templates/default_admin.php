                ...
                <div class="row">
                    <div class="setting-nav">
                        <ul class="d-flex">
                            ...
                            <li class="<?php echo ($class == 'vehicles') ? 'active' : '' ?>"><a href="javascript:void(0);<?php echo site_url('vehicles') ?>">Manage Vehicles</a></li>
                            <li class="<?php echo ($class == 'operators') ? 'active' : '' ?>"><a href="javascript:void(0);<?php echo site_url('operators') ?>">Manage Operators</a></li>
