                        ...
                        <form class="navbar-form navbar-left" method="get" action="<?php echo site_url('dashboard'); ?>" id="operations_report_form" style="border-left:3px solid #ff5722">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control pickadate-accessibility" placeholder="Select a date&hellip;" id="txt_date" name="txt_date" value="<?php
                                    if (isset($dataArr)) {
                                        if ($dataArr['end_date_data'] == '') {
                                            echo '';
                                        } else {
                                            echo date('d F, Y', strtotime($dataArr['end_date_data']));
                                        }
                                    } else {
                                        echo '';
                                    }
                            ...
                            <div class="form-group">
                                <select data-placeholder="Select a report..." class="select-size-sm border-warning text-warning btn-flat" name="txt_report_type">
                                    <option value="overview" <?php
                                    if ($report_type == 'overview') {
                                        echo 'selected';
                                    }
                                    ?> >Overview</option>
                                    <option value="dailycheck" <?php
                                    if ($report_type == 'dailycheck') {
                                        echo 'selected';
                                    }
                                    ?> >Daily Check</option>
                                    <option value="dailyalerts" <?php
                                    if ($report_type == 'dailyalerts') {
                                        echo 'selected';
                                    }
                                    ?> >Daily Alerts</option>
                                    <option value="faults" <?php
                                    if ($report_type == 'faults') {
                                        echo 'selected';
                                    }
                                    ?> >Faults</option>
                                    <option value="service_due" <?php
                                    if ($report_type == 'service_due') {
                                        echo 'selected';
                                    }
                                    ?> >Service Due</option>
                                    <option value="proof_of_delivery" <?php
                                    if ($report_type == 'proof_of_delivery') {
                                        echo 'selected';
                                    }
                                    ?> >Proof Of Delivery</option>
                                    <option value="incidents" <?php
                                    if ($report_type == 'incidents') {
                                        echo 'selected';
                                    }
                                    ?> >Incidents</option>
                                    <option value="operators" <?php
