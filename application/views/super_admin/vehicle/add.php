                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="radio col-md-12" style="padding-top:0px">
                                                                    <label class="control-label col-md-12"><input type="radio" name="vehicle_type" class="styled" value="car" <?php
                                                                        if (isset($dataArr)) {
                                                                            if ($dataArr['type'] == 'car') {
                                                                                echo 'checked';
                                                                            }
                                                                ...
                                                                <div class="radio col-md-12" style="padding-top:0px">
                                                                    <label class="control-label col-md-12"><input type="radio" name="vehicle_type" class="styled" value="van" <?php
                                                                        if (isset($dataArr)) {
                                                                            if ($dataArr['type'] == 'van') {
                                                                                echo 'checked';
                                                                            }
                                                                ...
                                                                <div class="radio col-md-12" style="padding-top:0px">
                                                                    <label class="control-label col-md-12"><input type="radio" name="vehicle_type" class="styled" value="flatbed_lorry" <?php
                                                                        if (isset($dataArr)) {
                                                                ...
                                                                <div class="radio col-md-12" style="padding-top:0px">
                                                                    <label class="control-label col-md-12"><input type="radio" name="vehicle_type" class="styled" value="articulated_lorry" <?php
                                                                        if (isset($dataArr)) {
                                                                            if ($dataArr['type'] == 'articulated_lorry') {
                                                                                echo 'checked';
                                                                            }
                                                                        }
                                                                        ?>>Articulated Lorry</label>
                                                                </div>
                                                                <div class="radio col-md-12" style="padding-top:0px">
                                                                    <label class="control-label col-md-12"><input type="radio" name="vehicle_type" class="styled" value="forklift_truck" <?php
                                                                        if (isset($dataArr)) {
                                                                            if ($dataArr['type'] == 'forklift_truck') {
                                                                                echo 'checked';
                                                                            }
                                                                        }
                                                                        ?>>Fork Lift Truck</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="radio col-md-12" style="padding-top:0px">
                                                                    <label class="control-label col-md-12"><input type="radio" name="odo_measurment" class="styled"  value="km" <?php
                                                                        if (isset($dataArr)) {
                                                                ...
                                                                <div class="radio col-md-12" style="padding-top:0px">
                                                                    <label class="control-label col-md-12"><input type="radio" name="odo_measurment" class="styled" value="miles" <?php
                                                                        if (isset($dataArr)) {
                                                                ...
                                                                <div class="radio col-md-12" style="padding-top:0px">
                                                                    <label class="control-label col-md-12"><input type="radio" name="odo_measurment" class="styled" value="hours" <?php
                                                                        if (isset($dataArr)) {
