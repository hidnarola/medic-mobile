                            ...
                            <div class="col-md-12">
                                <form method="post" id="add_area_form">
                                    <div class="panel panel-body">
                                            ...
                                            <div class="add-form-l">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select data-placeholder="Select a Region..." class="select form-control" id="txt_region_name" name="txt_region_name">
                                                            <option></option>
                                                            <?php
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group has-feedback">
                                                            ...
                                                            <div class="input-group">
                                                                <select data-placeholder="Select a Manager..." class="select form-control" id="txt_manager_name1" name="txt_manager_name1">
                                                                    <option></option>
                                                                    <?php
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group has-feedback">
                                                            ...
                                                            <div class="input-group">
                                                                <select data-placeholder="Select a Manager..." class="select form-control" id="txt_manager_name2" name="txt_manager_name2">
                                                                    <option></option>
                                                                    <?php
                                                                    foreach ($managerArr as $k => $v) {
                                                                        if (isset($dataArr)) {
                                        ...
                                        <div class="add-form-btn">                                                <button type="submit" class="btn btn-success btn-lg">Submit</button>
