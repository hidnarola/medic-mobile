...
<tr>
    <td style="padding:30px;text-align: center">
        <p><a href="<?php echo site_url('reset_password?q='.base64_encode($user_id).'&code='.$verification_code); ?>" class="btn_href">Reset your password</a></p>
    </td>
</tr>
<tr>
    <td>
...
<tr>
    <td style="color:#8e8e8e">
        ...
        <p><a href="javascript:void(0)" style="font-size:12px;color:#0079c1"><?php echo site_url('reset_password?q='.base64_encode($user_id).'&code='.$verification_code); ?></a></p>    
    </td>
</tr>
